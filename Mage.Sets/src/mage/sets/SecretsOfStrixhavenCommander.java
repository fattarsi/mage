...
public final class SecretsOfStrixhavenCommander extends ExpansionSet {
    ...
    // web-gateway fork: "Stensian Sanguinist" force-enabled (removed from unfinished) so it can be played;
    // upstream flags it pending verification of the new "prepare" mechanic. Re-apply after each rebase.
    private static final List<String> unfinished = Arrays.asList("Defacing Duskmage", "Dirgur Focusmage", "Eccentric Pestfinder", "Eiganjo Dynastorian", "Inspired Skypainter", "Lorehold Archivist", "Naktamun Lorespinner", "Striding Shotcaller", "Yavimaya Bloomsage");
    ...
    private SecretsOfStrixhavenCommander() {
        ...
        cards.add(new SetCardInfo("Inspired Skypainter", 48, Rarity.RARE, mage.cards.i.InspiredSkypainter.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Inspired Skypainter", 96, Rarity.RARE, mage.cards.i.InspiredSkypainter.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Nexus Mentality", 21, Rarity.RARE, mage.cards.n.NexusMentality.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Nexus Mentality", 71, Rarity.RARE, mage.cards.n.NexusMentality.class, NON_FULL_USE_VARIOUS));
